...
namespace OptimizelyGraph.Models.Blocks
{
    ...
    public class MinMaxRangeFormElementBlock : InputElementBlockBase, IElementCustomFormatValue, IElementRequireClientResources
    {
        ...
        // Public default constructor with some initialization logic
        public MinMaxRangeFormElementBlock()
        {
            // Initialize the HttpContextAccessor if it hasn't been set
            if (_httpContextAccessor == null)
            {
                // Initialize the HttpContextAccessor here
                _httpContextAccessor = new HttpContextAccessor();
            }
        }

        // Constructor with parameter for HttpContextAccessor injection
        public MinMaxRangeFormElementBlock(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public IEnumerable<Tuple<string, string>> GetExtraResources()
        {
            ...
            {
                new Tuple<string, string>("script", "/rangeForm.js")
            };
        }

        public override object GetSubmittedValue()
        {
            var rawSubmittedData = _httpContextAccessor.HttpContext.Request.Form;
